...
# change path ??
modelPath = '/data/wanshan/Desktop/robotics/humanoid-gym/resources/robots/pandaman/'
...
for i in range(5000):
    ...
    ref_dof_pos[:, 2] = -sin_pos_l * scale_1+initialAngle[2] # left hip
    ref_dof_pos[:, 3] = sin_pos_l * scale_2+initialAngle[3] # left knee
    ref_dof_pos[:, 4] = sin_pos_l * scale_1+initialAngle[4] # left ankle
